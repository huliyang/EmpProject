		...
		<div class="col-md-12">
			<div class="panel panel-info">
						...
						<c:if test="${allEmps != null}" var="res">
							<c:forEach items="${allEmps}" var="t_emp">
								<tr class="text-center">
									...
									<td>${t_emp.comm}</td>
									<td>
										<a href="<%=updateUrl%>?empno=${t_emp.empno}&backurl=<%=backUrl%>" class="btn btn-warning btn-xs">
				...
				<div class="panel-footer text-right">
					<button onclick="deleteAll('<%=deleteUrl%>?p=p&backurl=<%=backUrl%>','empno','empno')" class="btn btn-danger btn-sm">
